...
<header class="header">
  <div class="header-inner">
    <<?php if (is_front_page()): ?>h1<?php else: ?>div<?php endif; ?> class="header-logo">
      <a href="/" class="header-logo-link">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/logo.svg" alt="<?php if (is_front_page()): ?><?php echo get_the_title(); ?><?php else:?>株式会社三立ロゴ<?php endif; ?>">
      </a>
    ...
    <nav class="g-nav">
      <ul class="g-nav-list">
        <li class="g-nav-list__item"><a href="/#company-info">会社概要</a></li>
        <li class="g-nav-list__item"><a href="/#prod">サービス</a></li>
        <li class="g-nav-list__item"><a href="/#biz-partner">取引実績</a></li>
        <li class="g-nav-list__item"><a href="/contents/">新着情報</a></li>
        ...
        <li class="g-nav-list__item contact-button pc-only"><a href="/contact/" class="sr-btn-primary">お問い合せ&nbsp;&nbsp;<span class="sr-icon-right-arrow"></span></a></li>
      </ul>
...
<?php if(is_front_page()): ?>
  <section class="kv">
    <div class="kv-inner">
      <div class="kv-ttl">
        <p class="kv-ttl-sub">安心・安定・安全を提供する</p>
        <p class="kv-ttl-main"><span>自販機パーツ</span>のプロフェッショナル</p>
      </div>
    </div>
  </section>
<?php else: ?>
